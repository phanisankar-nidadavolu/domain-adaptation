...
tgt_cycle_loss_wt=5.0
src_idt_loss_wt=0.0
tgt_idt_loss_wt=0.0
src_sup_loss_wt=2.5
tgt_sup_loss_wt=10.0
...
if [ $stage -eq 0 ]; then
    ...
    qsub -e submit_scripts/logs/err${expid}_${model_name}_${model_ver}.log -o submit_scripts/logs/out${expid}_${model_name}_${model_ver}.log -cwd -l 'hostname=c[10][1256789]*,gpu=1' $sub_script $python_script $train_args || exit 1;

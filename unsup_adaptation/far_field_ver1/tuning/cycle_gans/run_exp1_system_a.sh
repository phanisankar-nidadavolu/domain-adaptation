...
# Loss wts
src_cycle_loss_wt=10.0  # src stands for reverb and tgt stands for clean
tgt_cycle_loss_wt=10.0
src_idt_loss_wt=5.0
tgt_idt_loss_wt=5.0
src_sup_loss_wt=0.0
tgt_sup_loss_wt=0.0
...
loss_label=lwts_cycle_src_${src_cycle_loss_wt}_tgt_${tgt_cycle_loss_wt}_idt_src_${src_idt_loss_wt}_tgt_${tgt_idt_loss_wt}_sup_src_${src_sup_loss_wt}_tgt_${tgt_sup_loss_wt}
...
if [ $stage -eq 1 ]; then
    source ~/.bashrc
    extract_cmd="queue.pl --max-jobs-run 50 -l arch=*64* -l ram_free=3G,mem_free=3G,\"hostname=[bc]*[1]*[123456789]*\" -V"
    ...
    for test_epoch in 65 70 60; do
      ...
      for name in sitw_eval_enroll_no_sil sitw_eval_test_no_sil sitw_dev_test_no_sil sitw_dev_enroll_no_sil \
                    sitw_eval_enroll_reverb_no_sil sitw_eval_test_reverb_no_sil sitw_dev_test_reverb_no_sil sitw_dev_enroll_reverb_no_sil; do

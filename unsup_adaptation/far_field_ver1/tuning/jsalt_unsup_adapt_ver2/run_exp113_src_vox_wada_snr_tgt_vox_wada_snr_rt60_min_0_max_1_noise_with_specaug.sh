...
exp_name=exp_${expid}_model_train_${trainer_ver}_${conv_label}_data_name_${data_name}_optim_${optim_type}_lr_${lr}_reg_${reg_label}_df_${data_format}_bs_${batch_size}_seq_len_${seq_len}_${loss_label}_sa_${apply_specaug}

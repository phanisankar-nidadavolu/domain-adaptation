...
feadir=data/$ftype
data_dir=$feadir/train_dirs/SRC_vox_wada_snr_TGT_vox_wada_rev_real_ps_and_voices_ps_5
...
conv_label=nres_${num_res_blocks}_nfilter_${nfilter}
loss_label=lwts_cy_src_${src_cycle_loss_wt}_tgt_${tgt_cycle_loss_wt}_idt_src_${src_idt_loss_wt}_tgt_${tgt_idt_loss_wt}_sup_src_${src_sup_loss_wt}_tgt_${tgt_sup_loss_wt}_adv_${adv_loss_wt}

...
feadir=data/$ftype
data_dir=$feadir/train_dirs/SRC_vox_wada_snr_TGT_voices_dev_ps_num_copies_1
...
norm_layer_type=batchnorm2d     # batchnorm2d or instancenorm2d
...
fwd_pass_epochs="10 15 20 25 30 35 40 45 50 55 60 65 70 75"

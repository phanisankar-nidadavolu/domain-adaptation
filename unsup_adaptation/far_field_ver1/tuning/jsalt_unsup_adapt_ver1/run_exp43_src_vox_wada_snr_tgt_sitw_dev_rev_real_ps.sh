...
feadir=data/$ftype
data_dir=$feadir/train_dirs/SRC_vox_wada_snr_TGT_sitw_dev_reverb_real_ps
...
if [ $stage -eq 0 ]; then
    ...
    if [ "$no_cuda" == "true" ]; then
        ...
        qsub -e submit_scripts/logs/err${expid}_${model_name}_${model_ver}.log -o submit_scripts/logs/out${expid}_${model_name}_${model_ver}.log -cwd -V -l 'hostname=[bc]1[3456789]*,gpu=1' $sub_script $python_script $train_args $fwd_pass_args || exit 1;

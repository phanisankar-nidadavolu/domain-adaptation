...
feadir=data/$ftype
data_dir=$feadir/train_dirs/SRC_vox_wada_snr_TGT_sitw_dev_reverb_small_ps
...
for name in sitw_dev_enroll sitw_dev_test sitw_eval_enroll sitw_eval_test; do
    for kwrd in min_0_max_pt5 min_pt5_max_1 real; do
...
fwd_pass_epochs="10 15 20 25 30 35 40 45 50 55 60 65 70"
